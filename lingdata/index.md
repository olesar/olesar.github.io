...
Д/з: Поиск в НКРЯ (дедлайн 21 сентября)  

#### 3. <a href="">Веб-корпуса (SketchEngine и Skell, Arraneum)</a>. Коллокации. Совместная встречаемость  
...
#### 5. Электронное представление текста. Форматы HTML, XML, Markdown. Кодировки файлов. Поиск с помощью регулярных выражений     
<a href="">Конспект лекции: форматы и кодировки</a>   
<a href="">Регулярные выражения</a>   

<a href="">Д/з</a>: Личная страничка в HTML (дедлайн 16 сентября). 
